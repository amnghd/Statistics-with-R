...
Higher number of samples decreases the uncertainty. 
</div>
...
$$
\begin{aligned}
P(M_1 \text{ is Bad} ~|~ \text{Win on } M_1) 
&= \frac{P(\text{Win on } M_1 ~|~ M_1 \text{ is Bad})~P(M_1 \text{ is Bad})}{P(\text{Win on } M_1)} \\
&= \frac{P(\text{Win on } M_1 ~|~ M_1 \text{ is Bad})~P(M_1 \text{ is Bad})}{P(\text{Win on } M_1 ~|~ M_1 \text{ is Good})~P(M_1 \text{ is Good})+P(\text{Win on } M_1 ~|~ M_1 \text{ is Bad})~P(M_1 \text{ is Bad})} \\
&= \frac{1/2 \times 1/3}{1/2 \times 1/2+1/3 \times 1/2} = 0.4
\end{aligned}
$$
<ol>
<li> 0.3 </li>
...
$$ p(M_1 \ is\ bad) = p(M_2\ is\ good ) = 0.4 $$
<ol>
<li> 0.3 </li>
<li> 0.4 </li>
<li> 0.5 </li>
...
```{r}
data = data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 1L), outcome = c("L", "L", "W", "W", "L", "L", "L", "L", "L", "W", "L", "W", "L", "W", "W", "L", "L", "W", "L", "W", "W", "W", "W", "L", "W", "W", "L", "L", "L", "L", "W", "L", "L", "W", "L", "W", "L", "L", "W", "L", "L", "L", "L", "L", "W", "W", "W", "W", "L", "L", "W", "W", "L", "L", "W", "W", "W", "L", "W", "W", "L", "L", "L", "W", "L", "W", "W", "L", "W", "L", "W", "L", "W", "L", "W", "L", "L", "L", "W", "W", "L", "L", "L", "L", "W", "L", "L", "W", "L", "L", "L", "L", "L", "L", "L", "L", "W", "L", "L", "W", "L", "L", "L", "L", "L", "W", "W", "W", "L", "L", "W", "W", "W", "W", "L", "L", "L", "W", "W", "W", "L", "W", "W", "L", "W", "L", "W", "W", "L", "W", "L", "W", "W", "L", "W", "L", "L", "W", "L", "L", "W", "L", "L", "L", "W", "W", "L", "L", "L", "L", "L", "W", "W", "L", "L", "W", "W", "L", "L", "W", "L", "L", "L", "W", "L", "L", "L", "W", "L", "L", "L", "W", "W", "L", "L", "W", "W", "L", "W", "L", "W", "W", "L", "W", "L", "L", "L", "W", "W", "W", "W", "W", "W", "W", "L", "L", "W", "W", "L", "W", "L", "L", "L", "L", "W", "L"))
plot_bandit_posterior(data)
bandit_posterior(data)# applet says machine 1 is good
```
