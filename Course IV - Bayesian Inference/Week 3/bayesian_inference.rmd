...
To conduct this hypothesis test we will again use the `bayes_inference` function but this time 

specify `type="ht"`, will then also need to provide the `null` and `alternative` arguments which define the null value (7) and the type of alternative hypothesis (`"twosided"`).
